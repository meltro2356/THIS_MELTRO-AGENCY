            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="text-lg text-gray-700 leading-relaxed space-y-6">
                  <p>
                    "Depois de anos atendendo grandes players de diversos setores, percebi o quanto o mercado pet care no Brasil estava carente de marketing digital especializado e com resultados reais."
                  </p>
