    ...
    <>
      ...
      <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50">
        <button
          ...
          className="bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 animate-pulse-slow"
        >
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl max-w-sm w-full mx-4 relative">
            ...
            <div className="space-y-3 sm:space-y-4">
              <button
                ...
                className="w-full bg-green-500 hover:bg-green-600 text-white py-2.5 sm:py-3 px-4 rounded-lg font-semibold transition-colors flex items-center justify-center text-sm sm:text-base"
              >
      ...
      {/* Widget Panel */}
      {isOpen && (
        <div className="fixed bottom-16 sm:bottom-24 right-4 sm:right-6 w-72 sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 z-40 animate-slide-up">
