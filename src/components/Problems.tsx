    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
              ...
              >
                <div className={`h-full ${problem.bgColor} relative`}>
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-center items-center p-8 sm:p-12 text-center">
                    ...
                    {/* Badge */}
                    <div className={`inline-block px-4 py-2 rounded-full bg-gradient-to-r ${problem.color} text-white text-sm font-medium mb-6`}>
                      {problem.audience}
                    </div>
          ...
          <button
            onClick={prevProblem}
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-700 p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110 z-20"
          >
          ...
          <button
            onClick={nextProblem}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-700 p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110 z-20"
          >
